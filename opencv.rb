...
#  sha1 'd16ced627db17f9864c681545f18f030c7a4cc0b'
  ...
  def install
    ...
    if build.with? "qt"
       args << "-DCMAKE_PREFIX_PATH='"+ENV["Qt5_DIR"]+"'"
	...
	inreplace "cmake/FindCUDA.cmake" do |s|
        s.gsub! " list(APPEND CUDA_LIBRARIES -Wl", "#list(APPEND CUDA_LIBRARIES -Wl"
	end
	
	args << "-DCMAKE_CXX_COMPILER=/usr/bin/c++"
	args << "-DCMAKE_C_COMPILER=/usr/bin/cc"
	args << "-DCUDA_HOST_COMPILER=/usr/bin/clang"
